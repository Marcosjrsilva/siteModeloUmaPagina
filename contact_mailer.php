...
$mail->Username = 'pirawebsites@gmail.com';             // SMTP username
$mail->Password = 'Niver@070678';                           // SMTP password
$mail->SMTPSecure = 'tls';
$mail->Port = 587;                                    // TCP port to connect to
// Adicione o endereço para enviar o email para
$mail->AddAddress('pirawebsites@gmail.com');
$mail->WordWrap = 50;                                 // Set word wrap to 50 characters
$mail->IsHTML(true);                                  // Set email format to HTML

// add your company name here
$company_name = 'Pira Web Sites';
...
$success_message->message   = 'Obrigado! Sua mensagem foi enviada';
...
$mail_error_message->message   = 'Desculpe seu e-mail não foi enviado - por favor, tente novamente mais tarde';
